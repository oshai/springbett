...
class TournamentCreator(
    ...
    private fun createTeams() {
        teamService.create(Team("ARGENTINA", "ARG", 5.5.toBigDecimal()))
        teamService.create(Team("AUSTRALIA", "AUS", 200.0.toBigDecimal()))
        teamService.create(Team("BELGIUM", "BEL", 12.0.toBigDecimal()))
        teamService.create(Team("BRAZIL", "BRA", 4.0.toBigDecimal()))
        teamService.create(Team("CAMERON", "CMR", 200.0.toBigDecimal()))
        teamService.create(Team("CANADA", "CAN", 100.0.toBigDecimal()))
        teamService.create(Team("COSTA RICA", "CRC", 500.0.toBigDecimal()))
        teamService.create(Team("CROATIA", "CRO", 35.0.toBigDecimal()))
        teamService.create(Team("DENMARK", "DEN", 20.0.toBigDecimal()))
        teamService.create(Team("ECUADOR", "ECU", 100.0.toBigDecimal()))
        teamService.create(Team("ENGLAND", "ENG", 6.0.toBigDecimal()))
        teamService.create(Team("FRANCE", "FRA", 6.0.toBigDecimal()))
        teamService.create(Team("GERMANY", "GER", 8.0.toBigDecimal()))
        teamService.create(Team("GHANA", "GHA", 200.0.toBigDecimal()))
        teamService.create(Team("IRAN", "IRN", 400.0.toBigDecimal()))
        teamService.create(Team("JAPAN", "JPN", 200.0.toBigDecimal()))
        teamService.create(Team("KOREA REPUBLIC", "KOR", 200.0.toBigDecimal()))
        teamService.create(Team("MEXICO", "MEX", 100.0.toBigDecimal()))
        teamService.create(Team("MOROCCO", "MAR", 150.0.toBigDecimal()))
        teamService.create(Team("NETHERLANDS", "NED", 10.0.toBigDecimal()))
        teamService.create(Team("POLAND", "POL", 90.0.toBigDecimal()))
        teamService.create(Team("PORTUGAL", "POR", 10.0.toBigDecimal()))
        teamService.create(Team("QATAR", "QAT", 200.0.toBigDecimal()))
        teamService.create(Team("SAUDI ARABIA", "KSA", 500.0.toBigDecimal()))
        teamService.create(Team("SENEGAL", "SEN", 60.0.toBigDecimal()))
        teamService.create(Team("SERBIA", "SRB", 60.0.toBigDecimal()))
        teamService.create(Team("SPAIN", "ESP", 7.0.toBigDecimal()))
        teamService.create(Team("SWITZERLAND", "SUI", 60.0.toBigDecimal()))
        teamService.create(Team("TUNISIA", "TUN", 300.0.toBigDecimal()))
        teamService.create(Team("URUGUAY", "URU", 35.0.toBigDecimal()))
        teamService.create(Team("USA", "USA", 70.0.toBigDecimal()))
        teamService.create(Team("WALES", "WAL", 100.0.toBigDecimal()))
    }
